...
$tgl1 = $_POST['tglsales1'];
$tgl2 = $_POST['tglsales2'];

$frtgl1=date_create($tgl1);
$frtgl2=date_create($tgl2);

header("Content-type: application/vnd-ms-excel");
header("Content-Disposition: attachment; filename=".$nmpeg."-Report ALL SO ".date_format($frtgl1,"d-m-Y")." sd ".date_format($frtgl2,"d-m-Y").".xls");
  ...
  $var1 = array('$expand' => 'Orders($select=DocEntry,DocNum,DocDate,DocumentStatus,CardCode,CardName,NumAtCard,Comments,DocTotal,SalesPersonCode,FederalTaxID,DocTime),SalesPersons($select=SalesEmployeeCode,SalesEmployeeName),PaymentTermsTypes($select=GroupNumber,PaymentTermsGroupName)','$filter' => 'Orders/SalesPersonCode eq SalesPersons/SalesEmployeeCode and Orders/PaymentGroupCode eq PaymentTermsTypes/GroupNumber and Orders/CancelStatus eq \'csNo\' and ((Orders/DocDate gt \''.$tgl1.'\' and Orders/DocDate lt \''.$tgl2.'\') or (Orders/DocDate eq \''.$tgl1.'\' or Orders/DocDate eq \''.$tgl2.'\'))','$orderby' => 'Orders/DocEntry desc');
...
<div class="page-content">
	<div class="row">
		<div class="col-6"><h4>Detail ORDERS ALL SALES Periode <?php echo date_format($frtgl1,"d-m-Y")." s/d ".date_format($frtgl2,"d-m-Y"); ?></h4></div>
