...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-file-invoice-dollar"></i> Data Sales Quotation</li>
  </ol>
</nav>
<div class="page-content">
	<div class="row">
		<div class="col-6"><h4>Data Quotation</h4></div>
		<div class="col-6 text-right">
			
			<a href="?page=datapenjualan" class="btn btn-sm btn-primary">
                Data Sales Orders
			</a>            
		</div>
	</div>
		    	 	...
		    	 	<tr>
						...
						<td><?php echo $terms; ?></td>
			 			...
			 			<td class="td-opsi">
													...
													<a href="?page=entry_dataquotation_upd&no_ord=<?php echo $docentry; ?>">
													<button class="btn-transition btn btn-outline-primary btn-sm" title="update sales quotation" name="tombol_update">
                            ...
                            <a href="?page=entry_dataquotation_copyorders&no_ord=<?php echo $docentry; ?>">
							<button class="btn-transition btn btn-outline-warning btn-sm" title="copy to sales orders" name="tombol_update">
