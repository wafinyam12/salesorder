...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-file-invoice-dollar"></i> Detail Penjualan per Bulan</li>
  </ol>
</nav>
<div class="page-content">
	<div class="row">
		<div class="col-6"><h4>Detail Penjualan <?php echo $ref; ?></h4></div>
		<div class="col-6 text-right">
		
		<a href="laporan/?page=export_excell&&bln=<?php echo $bln; ?>&ref=<?php echo $ref; ?>" target="_blank" class="btn btn-sm btn-primary">
				EXPORT KE EXCEL
		</a>
		</div>
	</div>
