...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-align-left"></i> Form Update Sales Order</li>
  </ol>
</nav>

<div class="page-content">
	<div class="row">
		<div class="col-6"><h4>UPDATE Sales Order</h4></div>
	...
	<div class="form-container">
		<div class="row" style="padding: 0 12px;">
			<div class="col-md-12 vertical-form">
				<h6> (<font color="red">**</font>) Lengkapi form atau dapat merubah data penjualan ini</h6>
        ...
        <form method="post" id="form_penjualan" autocomplete="off">
                ...
                <table width="100%" border="0" style="font-family:arial,tahoma; font-size: 14px;">
                    ...
                    <tr><td width="40%">No Trans </td><td width="2%"></td><td><input class="" size="12" type="hidden" name="no_entry" value="<?php echo $ordr; ?>" id=""><input class="" size="12" type="text" name="no_order" value="<?php echo $docnum; ?>" id="" disabled=""></td></tr>
                    ...
                    <tr><td width="40%">Tgl Orders </td><td width="2%"></td><td> <font color="blue"><b><input class="" size="10" type="date" name="tglsales" value="<?php echo $docdate; ?>" id="tglsales" disabled=""></b></font></td></tr>
                    <tr><td width="40%">Tgl Delivery <font color="red">**</font> </td><td width="2%"></td><td> <font color="blue"><b><input class="" size="10" type="date" name="tgldelivery" value="<?php echo $docduedate; ?>" id="tgldelivery"></b></font></td></tr>
                    <tr><td colspan="3"><h6></td></tr>

                    <tr><td width="40%">Jenis Trans </td><td width="2%"></td>
                                    <td> <b>
                                    
                                        <input type="text" class="form-control form-control-sm" data-toggle="" data-target="" rows="2" name="jenistrans" id="jenistrans" value="<?php if($doctype == "dDocument_Service"){ echo "Service"; } else { echo "Items"; } ?>" readonly>
                                        </b> 
                                    </td></tr>
                            ...
                            <table class="table display tabel-data" style="font-family:arial,tahoma; font-size: 12px;">
                                <thead>
                                    <tr>
                                        ...
                                        <?php if ($tipe == "1") { ?>
                                        <th class="text-right">Lbr <font color="red">**</font></th>
                                        <th class="text-right">Pjg <font color="red">**</font></th>
                                        <th class="text-right">Lmbr <font color="red">**</font></th>
                                        <?php } else { ?>
                                        ...
                                        <?php if ($tipe == "1") { ?>
                                        <th class="text-right">SPK Produksi</th>
                                        <?php } else { ?>
                                        <th class="text-right"></th>                                        
                                    	<?php } ?>
                                        <th class="text-right">Down Payment</th>
                                        <th class="text-right">Harga<br>(non PPN)<font color="red">**</font></th>
                                ...
                                <tbody id="">
                                    <?php
                                        ...
                                        for ($i=0;$i<count($data2x['DocumentLines']);$i++){
                                          ...
                                          $lb_item = $data21->DocumentLines[$i]->U_IT_Lebar;
                                          ...
                                          $var1dp = array('$expand' => 'DownPayments($select=DocEntry,DocNum),DownPayments/DocumentLines($select=DocEntry,LineNum)','$filter' => 'DownPayments/DocEntry eq DownPayments/DocumentLines/DocEntry and DownPayments/DocumentStatus eq \'bost_Open\'  and DownPayments/CancelStatus eq \'csNo\' and DownPayments/DocumentLines/BaseEntry eq '.$docentry.'','$orderby' => 'DownPayments/DocEntry asc');
                                          ...
                                          $response2dp = curl_exec($curl9);
                                          $err2dp = curl_error($curl9);
                                          ...
                                          <?php if ($tipe == "1") { ?>
                                            <td class="text-left"> <textarea style="background-color: #C0C0C0;" name="hidden_kdbrg<?php echo $count; ?>" id="td_kd_obat<?php echo $count; ?>" class="td_kd_obat" value="<?php echo $kd_item; ?>" rows="2" cols="25" readonly><?php echo $kd_item; ?></textarea></td>
                                            <td class="text-left"> <textarea name="hidden_nmbrg<?php echo $count; ?>" id="td_nmobat<?php echo $count; ?>" class="td_nmobat" value="" rows="3" cols="40" <?php if($doctype == "dDocument_Service"){ echo ""; } else { echo "style='background-color: #C0C0C0;' readonly"; } ?>><?php echo $nm_item; ?></textarea></td>
                                            <td class="text-right"> <input type="text" name="hidden_lbbrg<?php echo $count; ?>" id="td_lbobat<?php echo $count; ?>" class="text-right" size="6" value="<?php echo number_format($lb_item,2); ?>" onkeyup="Shitungx(<?php echo $count; ?>)" <?php if($doctype == "dDocument_Service"){ echo "style='background-color: #C0C0C0;' readonly"; } else { echo ""; } ?>></td>
                                            <td class="text-right"> <input type="text" name="hidden_pjbrg<?php echo $count; ?>" id="td_pjobat<?php echo $count; ?>" class="text-right" size="6" value="<?php echo number_format($pj_item,2); ?>" onkeyup="Shitungx(<?php echo $count; ?>)" <?php if($doctype == "dDocument_Service"){ echo "style='background-color: #C0C0C0;' readonly"; } else { echo ""; } ?>></td>
                                            <td class="text-right"> <input type="text" name="hidden_lbrbrg<?php echo $count; ?>" id="td_lbrobat<?php echo $count; ?>" class="text-right" size="6" value="<?php echo number_format($lbr_item,2); ?>" onkeyup="Shitungx(<?php echo $count; ?>)" <?php if($doctype == "dDocument_Service"){ echo "style='background-color: #C0C0C0;' readonly"; } else { echo ""; } ?>></td>
                                            <td class="text-right"> <input type="text" name="hidden_qty<?php echo $count; ?>" id="td_jmlobat<?php echo $count; ?>" class="text-right" size="8" value="<?php if($doctype == "dDocument_Service"){ echo number_format($qtyserv,2); } else { echo number_format($qty,2); } ?>" step="0.01" <?php if($doctype == "dDocument_Service"){ echo ""; } else { echo "style='background-color: #C0C0C0;' readonly"; } ?>></td>
                                          <?php } else { ?>
                                            <td class="text-left"> <textarea style="background-color: #C0C0C0;" name="hidden_kdbrg<?php echo $count; ?>" id="td_kd_obat<?php echo $count; ?>" class="td_kd_obat" value="<?php echo $kd_item; ?>" rows="2" cols="25" readonly><?php echo $kd_item; ?></textarea></td>
                                            <td class="text-left"> <textarea style="background-color: #C0C0C0;" name="hidden_nmbrg<?php echo $count; ?>" id="td_nmobat<?php echo $count; ?>" class="td_nmobat" value="" rows="3" cols="40" readonly><?php echo $nm_item; ?></textarea></td>
                                            <td class="text-right"> </td>
                                            <td class="text-right"> </td>
                                            <td class="text-right"> <input type="number" name="hidden_qty<?php echo $count; ?>" id="td_jmlobat<?php echo $count; ?>" class="text-right" size="8" value="<?php echo number_format($qty,2); ?>" step="any" onkeyup="Shitungujx(<?php echo $count; ?>)"></td>
                                          <?php } ?>
                                          <td class="text-right"> <?php echo number_format($qty-$openqty,2,".",","); ?></td>
                                          <td class="text-right"> <?php echo $nospk; ?></td>
                                          <td class="text-right"> <?php echo $nodp; ?></td>
                                          <?php if($tipesales == 1){ ?>
                                            <td class="text-right"> <input type="text" name="hidden_hrgsat<?php echo $count; ?>" id="td_satobat<?php echo $count; ?>" class="text-right" size="15" value="<?php echo number_format($hrg_sat,2); ?>" <?php if($doctype == "dDocument_Service"){ echo "readonly"; } else { echo "onkeyup='Shitungujx('.$count.')'"; } ?>></td>
                                          <?php } else { ?>
                                            <td class="text-right"> <input type="text" style="background-color: #C0C0C0;" name="hidden_hrgsat<?php echo $count; ?>" id="td_satobat<?php echo $count; ?>" class="text-right" size="15" value="<?php echo number_format($hrg_sat,2); ?>" <?php if($doctype == "dDocument_Service"){ echo "readonly"; } else { echo "onkeyup='Shitungx('.$count.')' readonly"; } ?>></td>
                                          <?php } ?>
                                            <td class="text-right"> <input type="text" name="hidden_subtotal<?php echo $count; ?>" id="td_subtotal<?php echo $count; ?>" class="text-right" value="<?php echo number_format($subtotalppn,2); ?>" <?php if($doctype == "dDocument_Service"){ echo ""; } else { echo "style='background-color: #C0C0C0;' readonly"; } ?>></td>
                                          <?php if ($docstatus == "bost_Open"){ if($doctype != "dDocument_Service"){ if ($qty == $openqty){ if ($nospk == '-' and $nodp == '-'){?>
                                            <td class="td-opsi"><button type="button" class="hapus_obat btn-transition btn btn-outline-danger btn-sm" name="ubah" id="<?php echo $count; ?>" data-toggle="modal" data-target="#modal_dataobat" title="update item ini">ubah</button></td>
                                          <?php }}}} ?>
                                          </tr>
                                        <?php
                                        } 
                                ...
                                <tfoot>
                                    ...
                                    <tr class="baris_total" style="">
                                        <td colspan="10" class="text-right" style="font-weight: bold;">Total (inc PPN) : <input type="text" style="background-color: #C0C0C0;" name="hidden_totalpenjualanppn" id="hidden_totalpenjualanppn" align="right" size="10" value="<?php echo $doctotal; ?>" readonly></td>
                                        <td class="td-opsi">
                    ...
                    <?php if ($docstatus == "bost_Open"){ if ($qty == $openqty){ if ($nospk == '-' and $nodp == '-'){ ?>
                      <input type="submit" name="update_penjualan" id="update_penjualan" class="btn btn-info" value="Update">
                    <?php }}} ?>
			            ...
			            for ($j=0;$j<count($data4xx['value']);$j++){                                      				
			                ...
			                if ($pricekode == $kodepl){
				              ...
				              if ($flasing == 'Y' || $nokcrimping == 'Y'){                  
				                  $harga1xx = round((int)$harga1xx*1.3);
				                  $harga2xx = round((int)$harga2xx*1.3);
				                  $harga3xx = round((int)$harga3xx*1.3);
				                  $hargahetxx = round((int)$hargahetxx*1.3);
				              }
				              if ($flasing450 == 'Y' || $flasing600 == 'Y' || $plat450 == 'Y' || $plat600 == 'Y'){
				                  $harga1xx = round((int)$harga1xx/2);
				                  $harga2xx = round((int)$harga2xx/2);
				                  $harga3xx = round((int)$harga3xx/2);
				                  $hargahetxx = round((int)$hargahetxx/2);
				              }
				              if ($flasing300 == 'Y' || $flasing300 == 'Y'){
				                  $harga1xx = round((int)$harga1xx/3);
				                  $harga2xx = round((int)$harga2xx/3);
				                  $harga3xx = round((int)$harga3xx/3);
				                  $hargahetxx = round((int)$hargahetxx/3);
				              }
				          }
                        ...
                        success:function(data) {
                            Swal.fire({
                              ...
                              confirmButtonText: 'OK'
                            	...
                            	document.getElementById("update_penjualan").removeAttribute("disabled");
                              if (ok.value) {
