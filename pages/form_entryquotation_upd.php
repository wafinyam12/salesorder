...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-align-left"></i> Form Update Sales Quotation</li>
  </ol>
</nav>

<div class="page-content">
	<div class="row">
		<div class="col-6"><h4>UPDATE Sales Quotation</h4></div>
	...
	<div class="form-container">
        ...
        <form method="post" id="form_penawaran" autocomplete="off">
                ...
                <table width="100%" border="0" style="font-family:arial,tahoma; font-size: 14px;">
                    ...
                    <tr><td width="40%">Tgl Quotation </td><td width="2%"></td><td> <font color="blue"><b><input class="" size="10" type="date" name="tglsales" value="<?php echo $docdate; ?>" id="tglsales" disabled=""></b></font></td></tr>
                    <tr><td width="40%">Valid Until <font color="red">**</font> </td><td width="2%"></td><td> <font color="blue"><b><input class="" size="10" type="date" name="tgldelivery" value="<?php echo $docduedate; ?>" id="tgldelivery"></b></font></td></tr>
                            ...
                            <table class="table display tabel-data" style="font-family:arial,tahoma; font-size: 12px;">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-right">Total<br><?php if($doctype == "dDocument_Service"){ echo "(exc PPN)<font color='red'>**</font>"; } else { echo "(inc PPN)"; } ?></th>
                                ...
                                <tbody id="">
                                    <?php
                                        ...
                                        for ($i=0;$i<count($data2x['DocumentLines']);$i++){
                                          ...
                                          <?php if ($docstatus == "bost_Open"){ if($doctype != "dDocument_Service"){ if ($qty == $openqty){ if ($nospk == '-' and $nodp == '-'){ if($kd_item <> "BSPC00001"){?>
                    ...
                    <?php if ($docstatus == "bost_Open"){ if ($qty == $openqty){ if ($nospk == '-' and $nodp == '-'){?>
                      <input type="submit" name="update_penawaran" id="update_penawaran" class="btn btn-info" value="Update">
                    <?php }}} ?>
...
$(document).ready(function() {
    ...
    $("#form_penawaran").on("submit", function(event){
        ...
        if(kode_cus==""){
            ...
            Swal.fire({
              title: 'Update ?',
              text: 'apakah anda telah mengisi data penawaran dengan benar ',
              type: 'warning',
                    ...
                    $.ajax({
                        ...
                        success:function(data) {
                            Swal.fire({
                              ...
                              document.getElementById("update_penawaran").removeAttribute("disabled"); 
                              if (ok.value) {
