<?php
  ...
  $nmpeg = $_SESSION['nama_peg'];
    ...
    //Load Customer
    $endpoint2 = 'https://172.16.226.2:50000/b1s/v1/$crossjoin(BusinessPartners,SalesPersons,PaymentTermsTypes)';
	...
	$url2 = $endpoint2 . '?' . http_build_query($params1);	
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-align-left"></i> Form Input DN Transport</li>
  </ol>
</nav>

<div class="page-content">
	<div class="row">
		<div class="col-6"><h4>Input DN Transport</h4></div>
	...
	<div class="form-container">
		<div class="row" style="padding: 0 12px;">
			<div class="col-md-12 vertical-form">
				<h6><i class="fas fa-list-alt"></i> Lengkapi form ini untuk menambah data DN Transport</h6>
                ...
                <table width="100%" border="0" style="font-family:arial,tahoma; font-size: 14px;">
                    ...
                    <tr><td width="40%">Tipe Trans </td><td width="2%"></td><td> <input type="hidden" class="form-control form-control-sm" name="kodetrans" id="kodetrans" onchange="nm()"> <select name="trans" id="trans" onchange="Stampiltrans()"><option value="" selected>-Pilih Transaksi-</option><option value="1">Sales Quotation</option><option value="2">Sales Orders</option></select> <font color="red"><b>(*)</b></font></td></tr>
                    <tr><td width="40%"><span id="tgltrans"></span></td><td width="2%"></td><td> <font color="blue"><b><input class="" size="10" type="date" name="tglsales" value="<?php echo date('Y-m-d'); ?>" id="tglsales" disabled=""></b></font></td></tr>
                    <tr><td width="40%"><span id="tgltrans2"></span></td><td width="2%"></td><td> <font color="blue"><b><input class="" size="10" type="date" name="tgldelivery" value="" id="tgldelivery"></b></font></td></tr>

                    <tr><td width="40%">Jenis Trans</td><td width="2%"></td><td>
                    <input type="radio" id="jenistrans" name="jenistrans" value="1" onchange="Stampiljenis()" checked="true">
                    ...
                    <tr><td width="40%">Customer </td><td width="2%"></td>
                                    <td> <b>
                                        ...
                                        <input type="text" class="form-control form-control-sm" data-toggle="modal" data-target="#modal_datacus" rows="2" name="kode_cus" id="kode_cus" readonly>
                                        </b> 
                                    </td></tr>

                    <tr><td width="40%">Nama </td><td width="2%"></td><td> <b><textarea class="form-control form-control-sm" name="nama_cus" id="nama_cus" readonly></textarea></b> </td></tr>

                    <tr><td width="40%">Payment Terms </td><td width="5%"></td><td> <b><input type="text" class="form-control form-control-sm" name="payterms" id="payterms" readonly></b> </td></tr>

                    
                    <tr><td width="40%">Cust. Currency </td><td width="5%"></td><td> <b><input type="text" class="form-control form-control-sm" name="cus_curr" id="cus_curr" readonly></b> </td></tr>
                    <tr><td width="40%">Currency Rate </td><td width="5%"></td><td> <b><input type="number" class="form-control form-control-sm" name="cus_rate" id="cus_rate"></b> </td></tr>
                    


                    <tr><td width="40%">Cust Ref. No. </td><td width="5%"></td><td> <b><input type="text" class="form-control form-control-sm" name="cus_ref" id="cus_ref"></b> </td></tr>

                    <tr><td width="40%">Kontak Person </td><td width="5%"></td><td> <b><input type="text" class="form-control form-control-sm" name="kontak" id="kontak"></b> </td></tr>                    

                    <tr><td width="40%">Alamat Kirim </td><td width="5%"></td><td> <b><textarea class="form-control form-control-sm" rows="2" name="alamat" id="alamat"></textarea></b> </td></tr>
                    <tr><td colspan="3"><h6></td></tr>
                    <tr><td width="40%">Gudang </td><td width="2%"></td><td> <b>
                        <input type="hidden" class="form-control form-control-sm" name="kode_gudang" id="kode_gudang" readonly>
                        <textarea class="form-control form-control-sm" data-toggle="modal" data-target="#modal_datagudang" rows="2" name="nama_gudang" id="nama_gudang" readonly></textarea></b> </td></tr>
                    <tr><td width="40%">Project </td><td width="2%"></td><td> <b>
                        <input type="hidden" class="form-control form-control-sm" name="kode_project" id="kode_project" readonly>
                        <textarea class="form-control form-control-sm" data-toggle="modal" data-target="#modal_dataproject" rows="2" name="nama_project" id="nama_project" readonly></textarea></b> </td></tr>
                    ...
                    <?php if ($tipe == "2"){?>
                    <tr><td width="40%">Harga Pengiriman </td><td width="5%"></td><td> <b><select class="form-control form-control-sm" name="note1" id="note1" onchange="mynote()"><option value="Harga belum termasuk pengiriman">Harga belum termasuk pengiriman</option><option value="Harga termasuk pengiriman ke lokasi">Harga termasuk pengiriman ke lokasi</option><option value="Harga Exwork Warehouse Utomo Solaruv">Harga Exwork Warehouse Utomo Solaruv</option><option value="Harga CIF Port Jakarta/Surabaya">Harga CIF Port Jakarta/Surabaya</option></select></b> </td></tr>
                    <tr><td width="40%">Waktu Pengiriman </td><td width="5%"></td><td> <b><select class="form-control form-control-sm" name="note2" id="note2" onchange="mynote()"><option value="3-7 Hari setelah pembayaran">3-7 Hari setelah pembayaran</option><option value="2-3 Bulan setelah PO diterima">2-3 Bulan setelah PO diterima</option></select></b> </td></tr>
                    <tr><td width="40%">Term Pembayaran </td><td width="5%"></td><td> <b><select class="form-control form-control-sm" name="note3" id="note3" onchange="mynote()"><option value="Pembayaran 100% sebelum pengiriman">Pembayaran 100% sebelum pengiriman</option><option value="DP 30% dan Pelunasan sebelum material dikirim/diambil">DP 30% dan Pelunasan sebelum material dikirim/diambil</option><option value="DP 30% dan Pelunasan setelah material diterima">DP 30% dan Pelunasan setelah material diterima</option><option value="14 Hari Setelah material diterima">14 Hari Setelah material diterima</option><option value="30 Hari Setelah material diterima">30 Hari Setelah material diterima</option><option value="Lainnya">Lainnya</option></select></b> </td></tr>
                    <tr><td width="40%">Masa Berlaku </td><td width="5%"></td><td> <b><select class="form-control form-control-sm" name="note4" id="note4" onchange="mynote()"><option value="Penawaran ini berlaku 7 hari dari tanggal terbit dan dapat berubah sebelum PO diterima">Penawaran ini berlaku 7 hari</option><option value="Penawaran ini berlaku 14 hari dari tanggal terbit dan dapat berubah sebelum PO diterima">Penawaran ini berlaku 14 hari</option><option value="Penawaran ini berlaku 30 hari dari tanggal terbit dan dapat berubah sebelum PO diterima">Penawaran ini berlaku 30 hari</option></select></b> </td></tr>
                    <tr><td width="40%">Garansi </td><td width="5%"></td><td> <b><select class="form-control form-control-sm" name="note5" id="note5" onchange="mynote()"><option value="Garansi Inverter 5 tahun">Garansi Inverter 5 tahun</option><option value="Garansi PV Module 12 tahun">Garansi PV Module 12 tahun</option></select></b> </td></tr> 
                    <tr><td width="40%">Note Tambahan </td><td width="5%"></td><td> <b><textarea class="form-control form-control-sm" rows="2" name="note6" id="note6" onkeyup="mynote()"></textarea></b> </td></tr>
                    <tr><td width="40%">Remark </td><td width="5%"></td><td> <b><textarea class="form-control form-control-sm" rows="8" name="remark" id="remark"></textarea></b> </td></tr>
                    <?php }else{ ?>
                      <tr><td width="40%">Remark </td><td width="5%"></td><td> <b><textarea class="form-control form-control-sm" rows="2" name="remark" id="remark"></textarea></b> </td></tr>
                    <?php } ?>

                    <tr><td colspan="3"><h6></td></tr>
                    <tr><td width="40%">No. Delivery Note </td><td width="5%"></td><td> <b><input type="text" class="form-control form-control-sm" name="nodn" id="nodn"></b> </td></tr>
                    <tr><td width="40%">Nomer Polisi </td><td width="5%"></td><td> <b><input type="text" class="form-control form-control-sm" name="nopol" id="nopol"></b> </td></tr>
                    <tr><td width="40%">Jenis Aktifitas </td><td width="5%"></td><td> <b><input type="text" class="form-control form-control-sm" name="jenisakt" id="jenisakt"></b> </td></tr>
                    <tr><td width="40%">Status Pembayaran </td><td width="5%"></td><td> <b><input type="text" class="form-control form-control-sm" name="stbayar" id="stbayar"></b> </td></tr>
                    <tr><td width="40%">Cust Ref. No. </td><td width="5%"></td><td> <b><input type="text" class="form-control form-control-sm" name="cus_ref" id="cus_ref"></b> </td></tr>
                    <tr><td width="40%">Cust Ref. No. </td><td width="5%"></td><td> <b><input type="text" class="form-control form-control-sm" name="cus_ref" id="cus_ref"></b> </td></tr>
                    <tr><td width="40%">Cust Ref. No. </td><td width="5%"></td><td> <b><input type="text" class="form-control form-control-sm" name="cus_ref" id="cus_ref"></b> </td></tr>
                    <tr><td width="40%">Cust Ref. No. </td><td width="5%"></td><td> <b><input type="text" class="form-control form-control-sm" name="cus_ref" id="cus_ref"></b> </td></tr>
                    ...
                    <div class="row kotak-form-tabel-penjualan">
                    	<div class="col-md-3 kotak-form-obat-terjual" style="display: ;" >
                                ...
                                <div class="position-relative form-group">
                                    ...
                                    <textarea name="nm_obat" id="nm_obat" placeholder="" rows="2" cols="5" class="form-control form-control-sm" readonly></textarea>
                                ...
                                <div class="position-relative form-group">
                                    ...
                                    <div class="input-group input-group-sm">
                                      <input type="number" class="form-control" id="pj_barang" name="pj_barang" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value="0" step="0.01" onkeyup="Shitung()">
                                      <div class="input-group-append">
                                ...
                                <div class="position-relative form-group">
                                    ...
                                    <div class="input-group input-group-sm">
                                      <input type="number" class="form-control" id="lbr_barang" name="lbr_barang" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value="0" onkeyup="Shitung()">
                                      <div class="input-group-append">
                                ...
                                <div class="position-relative form-group">
                                    ...
                                    <div class="input-group input-group-sm">
                                      <input type="number" class="form-control" id="lb_barang" name="lb_barang" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value="0">
                                      <div class="input-group-append">
                                ...
                                <div class="position-relative form-group">
                                    ...
                                    <div class="input-group input-group-sm">
                                    <?php if ($tipe == '1'){ ?>
                                      <input type="text" class="form-control" id="qty" name="qty" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value="0.00" step="0.01" readonly>
                                    <?php } else { ?>  
                                      <input type="number" class="form-control" id="qty" name="qty" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value="0" step="any" onkeyup="Shitunguj()">
                                    <?php } ?>  
                                      <div class="input-group-append">                                        
                                        <span class="input-group-text" id=""><?php if ($tipe == '1'){ echo "meter lari"; } else { echo "(unit/pcs)";} ?></span>
                                      </div>
                                  </div>
                                </div>
                                ...
                                <div class="position-relative form-group">
                                  ...
                                  <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control" id="hrg_sat" name="hrg_sat" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" onkeyup="Shitunguj()">
                                        </div>
                                </div>
                                <?php }else{?>
                                <div class="position-relative form-group">
                                  ...
                                  <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control" id="hrg_sat" name="hrg_sat" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" disabled="" onkeyup="Shitung()">
                                ...
                                <div class="position-relative form-group">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input name="toth_hrg" id="toth_hrg" placeholder="" type="number" class="form-control form-control-sm" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" step="0.01" readonly>
                                    </div>
                                </div>
					...
					<?php } ?>
                                ...
                                <tfoot>
                                    ...
                                    <tr class="baris_total" style="display: none;">
                                        <td colspan="9" class="text-right" style="font-weight: bold;">Sub Total <span id="totket3"></span> : <input type="text" name="hidden_totalpenjualan" id="hidden_totalpenjualan" align="right" size="10" disabled=""></td>
                                        <td class="td-opsi">
                                            <button type="button" class="btn-transition btn btn-outline-danger btn-sm" title="hapus semua item" id="hapus_semua_obat">del all</button>
                                        </td>
                                    </tr>
                                    <tr class="baris_total" style="display: none;">
                                        <td colspan="9" class="text-right" style="font-weight: bold;">Discount : <input type="text" name="total_diskon" id="total_diskon" align="right" size="4" onkeyup="Shitungpercent()"> % <input type="text" name="hidden_totaldiskon" id="hidden_totaldiskon" align="right" size="10" onkeyup="Shitungtotal()" readonly></td>
                                        <td class="td-opsi">
                                    ...
                                    <tr class="baris_total" style="display: none;">
                                        <td colspan="9" class="text-right" style="font-weight: bold;">Total <span id="totket4"></span> : <input type="text" name="hidden_totalpenjualanppn" id="hidden_totalpenjualanppn" align="right" size="10" disabled=""></td>
                                        <td class="td-opsi">
...
<!-- Modal Customer -->
<div class="modal fade" id="modal_datacus" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <?php 
         ...
         ?>
                <tr>
                    ...
                    <td class="td-opsi">                        
                        <button class="btn-transition btn btn-outline-dark btn-sm" title="pilih" id="tombol_pilihcus" name="tombol_pilihcus" data-dismiss="modal"
                            data-kodecus="<?php echo $cardcode; ?>"
                            data-namacus="<?php echo $cardname; ?>"   
                            data-alamat="<?php echo $address; ?>"            
                            data-terms="<?php echo $pay_terms; ?>"
         ...
         ?>
                <tr>
                    ...
                    <button class="btn-transition btn btn-outline-dark btn-sm " title="pilih" id="tombol_pilihobat2" name="tombol_pilihobat2" data-dismiss="modal"
                            data-kode="<?php echo $itemcode; ?>"
                            data-nama="<?php echo $itemname; ?>"
                            data-harga="<?php echo round(((int)$harga2xx/1.11),2); ?>"
                    ...
                    <button class="btn-transition btn btn-outline-dark btn-sm " title="pilih" id="tombol_pilihobat3" name="tombol_pilihobat3" data-dismiss="modal"
                            data-kode="<?php echo $itemcode; ?>"
                            data-nama="<?php echo $itemname; ?>"
                            data-harga="<?php echo round(((int)$harga3xx/1.11),2); ?>"
                    ...
                    <button class="btn-transition btn btn-outline-dark btn-sm " title="pilih" id="tombol_pilihobat4" name="tombol_pilihobat4" data-dismiss="modal"
                            data-kode="<?php echo $itemcode; ?>"
                            data-nama="<?php echo $itemname; ?>"
                            data-harga="<?php echo round(((int)$hargahetxx/1.11),2); ?>"
