...
<div class="page-content">
	<div class="row">
		...
		<div class="col-6 text-right">
			...
			<a href="?page=dataquotation" class="btn btn-sm btn-primary">
				Data Sales Quotation
			</a>
		    	 ...
		    	 ?>
		    	 	<tr>
						...
						<td><?php echo $terms; ?></td>
			 			...
			 			<td class="td-opsi">	                        
	                        <a href="?page=entry_datapenjualan_upd&no_ord=<?php echo $docentry; ?>">
														<button class="btn-transition btn btn-outline-primary btn-sm" title="update sales orders" name="tombol_update">
								                  <i class="fas fa-info-circle"></i>
								            </button>
													</a>
	                        <a href="laporan/?page=nota_penjualan&no_pjl=<?php echo $docentry; ?>" target="_blank">
                              <button class="btn-transition btn btn-outline-dark btn-sm" title="cetak" id="tombol_cetak" name="tombol_cetak">
                                  <i class="fas fa-print"></i>
                              </button>
                            </a>
                          
                          <a href="laporan/?page=relasi_map&no_pjl=<?php echo $docentry; ?>" target="_blank">
                              <button class="btn-transition btn btn-outline-success btn-sm" title="relasi map" id="tombol_relasi" name="tombol_relasi">
                                  <i class="fas fa-users float-right mt-1"></i>
                              </button>
                            </a> 
